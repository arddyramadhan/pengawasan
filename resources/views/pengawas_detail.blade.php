        ...
        <div class="card card-primary card-outline">
            <div class="card-body box-profile">
                <div class="text-center">
                    <img style="height: 200px; width: 200px"  class="profile-user-img img-fluid img-circle" src="{{ asset('storage/'.$user->foto) }}"
                        alt="User profile picture">
                </div>

                <h3 class="profile-username text-center">{{$user->name}}</h3>

                <p class="text-muted text-center">{{$user->jabatan->nm_jabatan}}</p>
                ...
                <ul class="list-group list-group-unbordered mb-3">
                    ...
                    <li class="list-group-item">
                        ...
                        @endforelse
                        <b>Informasi Awal</b> <a class="float-right">{{$ia}}</a>
                    </li>
                    <li class="list-group-item">
        ...
        <div class="card">
            <div class="card-header p-2">
                <ul class="nav nav-pills">
                    ...
                    <li class="nav-item"><a class="{{Request::segment(4) == null ? 'active' : ''}} nav-link" href="/user/{{$user->id}}/detail">Inforamsi Awal</a></li>
                    <li class="nav-item"><a class="{{Request::segment(4) == 'lhp' ? 'active' : ''}} nav-link" href="/user/{{$user->id}}/detail/lhp">Laporan Hasil Pengawasan</a></li>
                    <li class="nav-item"><a class="{{Request::segment(4) == 'tim' ? 'active' : ''}} nav-link" href="/user/{{$user->id}}/detail/tim">Tergabung Dalam tim</a></li>
                    @if ($user->id == Auth::user()->id || Auth::user()->level=='admin')
                        <li class="nav-item"><a class="{{Request::segment(4) == 'setting' ? 'active' : ''}} nav-link" href="/user/{{$user->id}}/detail/setting">Settings</a></li>                        
                    @endif
                </ul>
            </div><!-- /.card-header -->
            <div class="card-body">
                        ...
                        <div class="tab-pane active" id="settings">
                            <form action="/user/{{$user->id}}/edit" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="name" id="" value="{{$user->name}}" placeholder="Nama lengkap" class="form-control">
                                    </div>
                                </div>
                                        ...
                                        <div class="col-sm-10">
                                            <select name="id_jabatan" id="" class="form-control">
                                                ...
                                                @forelse ($jabatan as $jab)
                                                    <option {{$jab->id==$user->id_jabatan ? 'selected' : ''}} value="{{$jab->id}}">{{$jab->nm_jabatan}}</option>
                                                @empty
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="email" value="{{$user->email}}" name="email" id="" placeholder="Email." class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="jk" id="" class="form-control">
                                            <option disabled value="">Choose one!!</option>
                                            <option {{$user->jk == 'pria' ? 'selected' : ''}} value="pria">Laki - Laki</option>
                                            <option  {{$user->jk == 'wanita' ? 'selected' : ''}} value="wanita">Perempuan</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="alamat" value="{{$user->alamat}}" id="" placeholder="Alamat." class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Telp</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="tlp" id="" value="{{$user->tlp}}" placeholder="Nomor Telephone" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">

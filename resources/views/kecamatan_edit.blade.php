...
@if (Auth::user()->id_tingkatan==1)
    @section('judul', 'Edit Kecamatan')
@else
    @section('judul', 'Pengaturan Kecamatan')
@endif
        ...
        <div class="col-12">
            ...
            <form action="/kecamatan/{{$kecamatan->id}}/update" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="{{(old('nama') ?? $kecamatan->nama)}}" name="nama" id="nama" class="form-control">
                </div>
                <div class="form-group">
                    <label for="nama">Email</label>
                    <input type="email" value="{{(old('nama') ?? $kecamatan->email)}}" name="email" id="nama" class="form-control">
                </div>
                {{-- <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <input type="text" placeholder="Contoh : Bone" value="{{(old('ktp') ?? $kecamatan->almt_kecamatan)}}" name="almt_kecamatan" id="ktp" class="form-control">
                        </div>
                        <div class="col-md-4">
                            <label for="">Kelurahan/Desa</label>
                            <input type="text" placeholder="Contoh : Boludawa" value="{{(old('ktp') ?? $kecamatan->almt_kel_des)}}" name="almt_kel_des" id="ktp" class="form-control">
                        </div>
                        <div class="col-md-4">
                            <label for="">Jalan</label>
                            <input type="text" placeholder="Contoh : Suwawa" value="{{(old('ktp') ?? $kecamatan->almt_jalan)}}" name="almt_jalan" id="ktp" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="form-group">

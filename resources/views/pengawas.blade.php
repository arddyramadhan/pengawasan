                ...
                <div class="card bg-light d-flex flex-fill">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-5 text-center">
                                <img style="height: 130px; width: 130px"  src="{{ asset('storage/'.$item->foto) }}" alt="user-avatar"
                    ...
                    <div class="card-footer">
                        <div class="text-right">
                            @if ((Auth::user()->level=='admin') || (Auth::user()->level=='super'))
                    ...
                    <div class="form-group">
                        ...
                        <select name="id_jabatan" id="" class="form-control">
                            ...
                            @forelse ($jabatan as $jab)
                                @if (Auth::user()->id_tingkatan == 1 ) {{-- kabupaten --}}
                                    @if (($jab->id <= 8) || ($jab->id == 11))

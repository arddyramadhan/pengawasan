...
<div class="d-flex justify-content-end mb-3">
	<button type="button" data-container="body" data-toggle="modal" data-target="#addpengawas" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Tambah Pengawas</button>
</div>
                ...
                <div class="card bg-light d-flex flex-fill">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-5 text-center">
                                <img style="height: 130px; width: 130px"  src="<?php echo e(asset('storage/'.$item->foto)); ?>" alt="user-avatar"
                    ...
                    <div class="card-footer">
                        <div class="text-right">
                            <?php if((Auth::user()->level=='admin') || (Auth::user()->level=='super')): ?>
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/user/kabupaten/store" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('master.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\skripsi\app\pengawasan\resources\views/pengawas.blade.php ENDPATH**/ ?>